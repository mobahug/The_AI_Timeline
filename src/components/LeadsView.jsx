...
import { LEADS, buildLead } from '../lib/leads.js';
import { INK, MONO, SANS, SERIF, RULE, ink, micro, shell } from '../lib/styles.js';
import { Btn, Eyebrow, Link, PageHead } from './kit.jsx';
