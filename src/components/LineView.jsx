...
import { INK, MONO, RED_LIT, SANS, SERIF, RULE, ink, micro, shell } from '../lib/styles.js';
import { Claim, Eyebrow, Link, Ref } from './kit.jsx';
...
const onBoard = (id) => ({ view: 'board', id, category: 'all', query: '' });
const Hop = ({ from, claim, to }) => (
