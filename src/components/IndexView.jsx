...
import { accent, catLabel, groupByEra } from '../lib/data.js';
import { INK, MONO, SANS, SERIF, RULE, ROW_RULE, badge, ink, shell, tag } from '../lib/styles.js';
import { Eyebrow, Link } from './kit.jsx';

/** The archive: everything, dense, no photographs. */
export default function IndexView({ items }) {
  return (
