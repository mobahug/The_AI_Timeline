...
import type { Event, Media, Route, ViewId } from '../lib/types';
import type { Navigate } from '../lib/url';
import { SERIF, shell } from '../lib/styles';
import IndexView from './IndexView';
import PlatesView from './PlatesView';
import MosaicView from './MosaicView';
import { Empty, PageHead, Segmented } from './kit';
...
const MODES: [ViewId, string][] = [
  ['archive', 'List'],
  ['plates', 'Plates'],
  ['mosaic', 'Mosaic']
];

export interface ArchiveViewProps { mode: ViewId; items: Event[]; media: Media; route: Route; navigate: Navigate }

function ArchiveView({ mode, items, media, route, navigate }: ArchiveViewProps) {
  return (
    <>
