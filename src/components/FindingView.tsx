...
const findingLabel = (r: Row) => String(r.finding.n).padStart(2, '0') + ' · ' + r.finding.title;

export interface FindingViewProps { graph: Graph; route: Route; navigate: Navigate; onOpen: (id: string) => void; media: Media }

function FindingView({ graph, route, navigate, onOpen, media }: FindingViewProps) {
