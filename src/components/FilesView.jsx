...
import { PEOPLE, ORGS, TERMS, appearancesOf } from '../lib/files.js';
import { INK, MONO, SANS, SERIF, RULE, ROW_RULE, ink, micro, shell } from '../lib/styles.js';
import { Anchor, Btn, Eyebrow, Link, PageHead, Section } from './kit.jsx';
...
const withCounts = (graph, list) => list
